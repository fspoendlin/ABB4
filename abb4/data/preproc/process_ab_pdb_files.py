...
def process_file(file_path: str, write_dir: str, rerun_blobb: bool = False, sep_dirs: bool = False):
    """
...
def process_serially(all_paths, write_dir, rerun_blobb, sep_dirs):
    all_metadata = []
    # all_vh_angles = []
    # all_vl_angles = []
...
def main(args):
    ...
    merged_df = pd.merge(metadata_df, filtered_csv,
                        left_on='pdb_name', right_on='ID', how='inner')
